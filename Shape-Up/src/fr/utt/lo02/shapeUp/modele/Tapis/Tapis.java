...
/**
 * Classe qui donne les propriétés du plateau du jeu.
 * @author Sam Noel 
 *
 */
 ...
 */
	...
	/**
	 * Cette méthode permet de récupérer la valeur minimale de X du plateau. 
	...
	/**
	 * Cette méthode permet de récupérer la valeur maximale de X du plateau.
	...
	/**
	 * Cette méthode permet de récupérer la valeur minimale de Y du plateau. 
	...
	/**
	 * Cette méthode permet de récupérer la valeur maximale de Y du plateau.
	...
	/**
	 * Cette méthode permet de calculer la longueur du plateau. 
	 * @return La longueur du plateau 
	 */
	public int longueurPlateau() {
		// peut utiliser les mï¿½thodes de tapis pour trouver les x et les y min/max 
		int longueur;
	...
	/**
	 * Cette méthode permet de calculer la hauteur du plateau
	...
	/**
	 * Cette méthode test la verticalité du plateau 
	 * @param hauteur La hauteur du plateau
	 * @param longueur la longueur du plateau
	 * @return un booléen qui confirme la verticalité du plateau
	 */
	...
	/**
	 * Cette méthode test l'horizontalité du plateau
	 * @param hauteur La hauteur du plateau
	 * @param longueur La longueur du plateau
	 * @return Un booléen qui confirme l'horizontalité du plateau
	 */
	...
	/**
	 * Cette méthode test si une position est déja utilisée dans le plateau. 
	 * @param position La position à tester
	 * @return Un booléen qui confirme si la position est utilisée 
	 */
	...
	/**
	 * Cette méthode test si une position est adjacente à d'autres position de carte sur le plateau
	 * @param position La position à tester 
	 * @return Un booléen qui confirme si la position est adjacente à d'autres positions de carte 
	 */
	...
	/**
	 * Cette méthode permet de vérifier, après l'ajout d'une carte sur le plateau, si la disposition des cartes est valide 
	 * @param position La position à rajouter sur le plateau 
	 * @return Un booléen qui confirme la validité de disposition 
	 */
